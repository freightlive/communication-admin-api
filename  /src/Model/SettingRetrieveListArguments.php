...
/**
 * SettingRetrieveListArguments Class Doc Comment
 *
 * @category    Class */
/**
 * @package     BumbalCommunicationAdmin
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SettingRetrieveListArguments implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SettingRetrieveListArguments';
    ...
    const SORTING_COLUMN_KEY = 'key';
    const SORTING_COLUMN_VALUE = 'value';
    ...
    public function getSortingColumnAllowableValues()
    {
        return [
            ...
            self::SORTING_COLUMN_KEY,
            self::SORTING_COLUMN_VALUE,
        ];
    }
    ...
    {
        $invalid_properties = [];
        $allowed_values = ["id", "key", "value"];
        if (!in_array($this->container['sorting_column'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sorting_column', must be one of 'id', 'key', 'value'.";
        }
    ...
    {
        $allowed_values = array('id', 'key', 'value');
        if (!is_null($sorting_column) && (!in_array($sorting_column, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'id', 'key', 'value'");
        }
