...
------------- | ------------- | ------------- | -------------
 **body** | [**\BumbalCommunicationAdmin\Model\MappingModel**](../Model/MappingModel.md)| Mapping object | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\BumbalCommunicationAdmin\Model\MappingRetrieveListArguments**](../Model/MappingRetrieveListArguments.md)| Mapping RetrieveList Arguments |
 ...
 **body** | [**\BumbalCommunicationAdmin\Model\MappingModel**](../Model/MappingModel.md)| Activity object that needs to be updated | [optional]
