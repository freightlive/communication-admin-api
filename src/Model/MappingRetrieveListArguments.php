...
/**
 * MappingRetrieveListArguments Class Doc Comment
 *
 * @category    Class */
/**
 * @package     BumbalCommunicationAdmin
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MappingRetrieveListArguments implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'MappingRetrieveListArguments';
    ...
    const SORTING_COLUMN_MESSAGE_TYPE_NAME = 'message_type_name';
    const SORTING_COLUMN_TAGS = 'tags';
    ...
    public function getSortingColumnAllowableValues()
    {
        return [
            ...
            self::SORTING_COLUMN_MESSAGE_TYPE_NAME,
            self::SORTING_COLUMN_TAGS,
        ];
    }
    ...
    {
        $invalid_properties = [];
        $allowed_values = ["id", "message_type_name", "tags"];
        if (!in_array($this->container['sorting_column'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sorting_column', must be one of 'id', 'message_type_name', 'tags'.";
        }
    ...
    {
        $allowed_values = array('id', 'message_type_name', 'tags');
        if (!is_null($sorting_column) && (!in_array($sorting_column, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'id', 'message_type_name', 'tags'");
        }
